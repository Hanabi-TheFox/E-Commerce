...
public class ServletPayerCommande extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if(carte.equals(client.getCompteBancaireNum())){
            ...
            if(client.getCompteBancaireSolde().floatValue() >= commande.getPrix()){
                ...
                // /!\ A retravailler : mise ne place d'un message d'erreur + rester sur le form si possible /!\
                // /!\ A retravailler : mise ne place d'un message d'erreur + rester sur le form si possible /!\
                System.out.println("Solde trop faible (solde actuel = " + client.getCompteBancaireNum() + ") => retour à l'accueil");
                response.sendRedirect("ServletProduits");
            }
            ...
            // /!\ A retravailler : mise ne place d'un message d'erreur + rester sur le form si possible /!\
            // /!\ A retravailler : mise ne place d'un message d'erreur + rester sur le form si possible /!\
            System.out.println("Numero de carte invalide : carte != " + client.getCompteBancaireSolde() + " => retour à l'accueil");
            response.sendRedirect("ServletProduits");
        }
    }
